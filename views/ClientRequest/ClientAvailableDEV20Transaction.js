...
import { getDEV20Balances } from '../../scripts/helpers/devinals';

export function ClientAvailableDEV20Transaction({
  params,
  connectedClient,
  ...
  useEffect(() => {
    ...
    (async () => {
      setPageLoading(true);
      const balances = await getDEV20Balances(connectedClient?.address, ticker);
  ...
  return (
    <>
      ...
      <Text fontSize='13px' fontWeight='semibold' pt='6px'>
        Network fee: <Text fontWeight='normal'>Dev {transaction?.fee}</Text>
      </Text>
