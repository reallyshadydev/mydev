...
export function ClientConnect({ params, wallet, handleResponse }) {
  ...
  const onRejectConnection = useCallback(() => {
    handleResponse({
      toastMessage: `MyDev failed to connected to ${origin}`,
      toastTitle: 'Connection Failed',
      error: 'Unable to connect to MyDev',
    });
  ...
  return (
    <>
      ...
      <Text fontSize='2xl' pb='6px'>
        Connect with <Text fontWeight='bold'>MyDev</Text>
      </Text>
                    ...
                    <VStack>
                      ...
                      <Text color='gray.400' fontSize='xs'>
                        {addressBalances[address] ? (
                          <>
                            <Text fontWeight='bold'>Balance: </Text>Dev
...
const ConfirmationModal = ({
  ...
  const onConnect = useCallback(() => {
    handleResponse({
      toastMessage: `MyDev has connected to ${origin}`,
