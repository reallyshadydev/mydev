...
//console.log("useAppContext() data:", contextData);
  const {
    transactions,
  ...
  //console.log(transactionsData.transactions, 'transactionsData33')
  ...
  const onBuy = useCallback(() => {
    window.open('https://mecacex.com/market/DEVUSDT');
  }, []);

  const [routes] = useState([
    { key: 'transactions', title: 'Transactions' },
    { key: 'devinals', title: 'NFTs' },
